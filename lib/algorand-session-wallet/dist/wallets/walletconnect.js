...
class WC {
    constructor(network) {
        ...
        this.connector = new client_1({
            bridge,
            qrcodeModal: algorand_walletconnect_qrcode_modal_1,
        });
    }
    connect(cb) {
